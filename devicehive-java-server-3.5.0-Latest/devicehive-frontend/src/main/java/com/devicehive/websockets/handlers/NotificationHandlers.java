...
import static com.devicehive.configuration.Messages.NO_ACCESS_TO_IEXPERIMENTS_OR_NETWORKS_OR_ICOMPONENTS;
...
public class NotificationHandlers {
    ...
    public void processNotificationSubscribe(String deviceId, JsonObject request,
        ...
        logger.debug("notification/subscribe requested for device: {}. Networks: {}. Iexperiments: {}. Icomponents: {}. Timestamp: {}. Names {} Session: {}",
        ...
        if (!filters.isEmpty()) {
            ...
            logger.debug("notification/subscribe done for devices: {}. Networks: {}. Iexperiments: {}. Icomponents: {}. Timestamp: {}. Names {} Session: {}",
            ...
            ((CopyOnWriteArraySet) session
                    ...
                    .add(new SubscriptionInfo(pair.getLeft(), NOTIFICATION, deviceId, networks, iexperiments, icomponents, names, timestamp));
