...
public class Messages {
    ...
    public static final String IEXPERIMENTS_NOT_FOUND = BidBundle.get("IEXPERIMENTS_NOT_FOUND");
    public static final String IEXPERIMENT_NOT_FOUND = BidBundle.get("IEXPERIMENT_NOT_FOUND");
    ...
    public static final String USER_IEXPERIMENT_NOT_FOUND = BidBundle.get("USER_IEXPERIMENT_NOT_FOUND");
    ...
    public static final String IEXPERIMENT_REQUIRED = BidBundle.get("IEXPERIMENT_REQUIRED");
    public static final String IEXPERIMENT_ID_REQUIRED = BidBundle.get("IEXPERIMENT_ID_REQUIRED");
    public static final String DUPLICATE_IEXPERIMENT = BidBundle.get("DUPLICATE_IEXPERIMENT");
    public static final String NO_ACCESS_TO_IEXPERIMENT = BidBundle.get("NO_ACCESS_TO_IEXPERIMENT");
    public static final String IEXPERIMENT_CREATION_NOT_ALLOWED = BidBundle.get("IEXPERIMENT_CREATION_NOT_ALLOWED");
    public static final String IEXPERIMENT_DELETION_NOT_ALLOWED = BidBundle.get("IEXPERIMENT_DELETION_NOT_ALLOWED");
    public static final String IEXPERIMENT_ASSIGNMENT_NOT_ALLOWED = BidBundle.get("IEXPERIMENT_ASSIGNMENT_NOT_ALLOWED");
    ...
    public static final String NO_ACCESS_TO_IEXPERIMENTS_OR_NETWORKS_OR_ICOMPONENTS = BidBundle.get("NO_ACCESS_TO_IEXPERIMENTS_OR_NETWORKS_OR_ICOMPONENTS");
