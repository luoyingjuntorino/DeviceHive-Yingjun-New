...
public enum HiveAction {
    ...
    GET_IEXPERIMENT(17, Constants.GET_IEXPERIMENT),
    MANAGE_IEXPERIMENT(18, Constants.MANAGE_IEXPERIMENT),

    GET_ICOMPONENT(19, Constants.GET_ICOMPONENT),
    MANAGE_ICOMPONENT(20, Constants.MANAGE_ICOMPONENT);

    private static Set<HiveAction> CLIENT_ACTIONS = ImmutableSet.of(GET_NETWORK, GET_IEXPERIMENT, GET_ICOMPONENT, GET_DEVICE, GET_DEVICE_NOTIFICATION,
    ...
    private static Set<HiveAction> ADMIN_ACTIONS = ImmutableSet.of(MANAGE_USER, MANAGE_CONFIGURATION, MANAGE_NETWORK,
            MANAGE_IEXPERIMENT, MANAGE_ICOMPONENT);
