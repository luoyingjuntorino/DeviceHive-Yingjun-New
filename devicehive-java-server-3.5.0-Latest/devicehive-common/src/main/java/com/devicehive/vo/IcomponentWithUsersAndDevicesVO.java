...
import static com.devicehive.json.strategies.JsonPolicyDef.Policy.ICOMPONENT_PUBLISHED;

public class IcomponentWithUsersAndDevicesVO extends IcomponentVO {
    ...
    public IcomponentWithUsersAndDevicesVO() {}

    public IcomponentWithUsersAndDevicesVO(IcomponentVO vo) {
        setId(vo.getId());
        setName(vo.getName());
