...
public class IcomponentUpdate implements HiveEntity {

    // private static final long serialVersionUID = -4134073649300446791L;
    private static final long serialVersionUID = -4134993649300446791L;
    ...
    public IcomponentVO convertTo() {
        IcomponentVO icomponentVO = new IcomponentVO();
        icomponentVO.setName(name);
        icomponentVO.setDescription(description);
